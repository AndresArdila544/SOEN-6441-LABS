...
public class FilteringApples {
    ...
    public static class AppleWeightFormatter implements AppleFormatter{
        ...
        public String format(Apple a) {
            return String.valueOf(a.weight);
        }
    }

    public static class AppleHeavyOrLightFormatter implements AppleFormatter{
        @Override
        public String format(Apple a) {
            return a.weight>150? "Heavy":"Light";
        }
    }
}
